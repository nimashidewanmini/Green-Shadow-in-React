...
export function Crop() {
    ...
    const buttonStyle = { backgroundColor: "#000000" };
    ...
    return (
        <div className="container">
            <h2 className="text-center mb-4 mt-3" style={{ backgroundColor: "#c7f367", color: "black" }}>Crop</h2>

            <form id="cropForm" encType="multipart/form-data" name="FormData">
                <div className="form-group row">
                    <div className="col-md-4">
                        <label htmlFor="cropCode1">Crop Code</label>
                        <input type="text" className="form-control" style={{ backgroundColor: "#c7f367" }} id="cropCode1" name="cropCode" required value={crop?.cropCode || ""} onChange={handleChange} />
                    </div>
                    <div className="col-md-4">
                        <label htmlFor="cropCommonName">Crop Common Name</label>
                        <select className="form-control" style={{ backgroundColor: "#c7f367" }} id="cropCommonName" name="cropCommonName" required value={crop?.cropCommonName || ""} onChange={handleChange}>
                    ...
                    <div className="col-md-4">
                        ...
                        <select className="form-control" style={{ backgroundColor: "#c7f367" }} id="cropScientificName" name="cropScientificName" required value={crop?.cropScientificName || ""} onChange={handleChange}>
                ...
                <div className="form-group row">
                    <div className="col-md-4">
                        ...
                        <input type="file" className="form-control file-input" style={{ backgroundColor: "#c7f367" }} id="cropImage" name="cropImage" accept="image/*" onChange={handleChange} />
                    </div>
                    <div className="col-md-4">
                        <label htmlFor="category">Crop Category</label>
                        <select className="form-control" style={{ backgroundColor: "#c7f367" }} id="category" name="category" required value={crop?.category || ""} onChange={handleChange}>
                    ...
                    <div className="col-md-4">
                        ...
                        <input type="number" className="form-control" style={{ backgroundColor: "#c7f367" }} id="qty" name="qty" required value={crop?.qty || ""} onChange={handleChange} />
                    </div>
                </div>
                ...
                <div className="form-group row">
                    <div className="col-md-4">
                        ...
                        <select className="form-control" style={{ backgroundColor: "#c7f367" }} id="cropSeason" name="cropSeason" required value={crop?.cropSeason || ""} onChange={handleChange}>
                            {seasons.map((option) => (
                                <option key={option.value} value={option.value}>{option.label}</option>
                            ))}
                        </select>
                    ...
                    <div className="col-md-4">
                        ...
                        <select className="form-control" style={{ backgroundColor: "#c7f367" }} id="fieldCodes" name="fieldCodes" required value={crop?.fieldCodes || ""} onChange={handleChange}>
                            {/* Add options here */}
                        </select>
                    </div>
                    <div className="col-md-4">
                        <label htmlFor="fieldNames">Field Names</label>
                        <input type="text" className="form-control" style={{ backgroundColor: "#c7f367" }} id="fieldNames" name="fieldNames" required value={crop?.fieldNames || ""} onChange={handleChange} />
                    </div>
                </div>
